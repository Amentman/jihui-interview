...
| 8. 写入 | 确认目标位置 | 只新建或追加结构化 Markdown，保留来源 | README 和六类知识文件 |
...
- 已有知识库：禁止移动、改名、删除旧文件；只在用户给出的目录内新建或追加。
...
- 19 题已经回答，或由用户明确跳过。
- 六类知识都有真实信息；不足的部分明确列为待补充。
- 客户高频问题至少 3 个，好评原话至少 2 句，至少有 1 个真实故事；如果达不到，报告里必须说清楚。
